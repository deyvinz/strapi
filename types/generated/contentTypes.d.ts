...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blog: Schema.Attribute.Component<'about-page.detail', false> &
      Schema.Attribute.Required;
    contactSection: Schema.Attribute.Component<'about-page.detail', false> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    seo: Schema.Attribute.Component<'shared.seo', false> &
      Schema.Attribute.Required;
    team: Schema.Attribute.Component<'about-page.detail', false> &
      Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vision: Schema.Attribute.Component<'about-page.detail', false> &
      Schema.Attribute.Required;
  };
}
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    commentStatus: Schema.Attribute.Enumeration<
...
export interface ApiContactFormContactForm extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    messageStatus: Schema.Attribute.Enumeration<['pending', 'read', 'replied']>;
